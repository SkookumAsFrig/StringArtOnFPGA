...
stringArt_custom2( ...
    'inputFilePath', 'input/ada_ori.png', ... % path to the input file
    'outputDirPath', 'output/ada_ori', ... % path to the output directory
    'outputFileNamePrefix', 'ada_ori', ... % prefix of the output files
