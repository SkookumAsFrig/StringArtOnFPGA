function [A, x] = stringArt_custom2(varargin)
% Set Default Values
invertInput = true;
invertOutput = true;
numPins = 256;
...
[reduction, finalimage, points] = addremove_oneiter2(targetImage, numPins, stringstruct, currimage, add_rem);
tic
idx = 1;
lastidx = 1;
%for i=1:9
while reduction>0
    [reduction, finalimage, points] = addremove_oneiter2(targetImage, numPins, stringstruct, finalimage, add_rem);
    idx = idx+1;
    if mod(idx,20)==0
        disp(toc)
        disp(idx)
