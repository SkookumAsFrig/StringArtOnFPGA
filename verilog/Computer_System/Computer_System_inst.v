	Computer_System u0 (
		...
		.pio_add_remove_external_connection_export (<connected-to-pio_add_remove_external_connection_export>), // pio_add_remove_external_connection.export
		.pio_done_external_connection_export       (<connected-to-pio_done_external_connection_export>),       //       pio_done_external_connection.export
		.pio_pinpos1_external_connection_export    (<connected-to-pio_pinpos1_external_connection_export>),    //    pio_pinpos1_external_connection.export
		.pio_pinpos2_external_connection_export    (<connected-to-pio_pinpos2_external_connection_export>),    //    pio_pinpos2_external_connection.export
		.pio_req_external_connection_export        (<connected-to-pio_req_external_connection_export>),        //        pio_req_external_connection.export
		.pio_resp_rdy_external_connection_export   (<connected-to-pio_resp_rdy_external_connection_export>),   //   pio_resp_rdy_external_connection.export
		.pio_resp_val_external_connection_export   (<connected-to-pio_resp_val_external_connection_export>),   //   pio_resp_val_external_connection.export
